    ...
    <Document title={`GHG Inventory — ${company.name}`}>
      <Page size="LETTER" style={s.page}>
        ...
        <View style={s.headerRule}>
          ...
          <Text style={s.metaSmall}>Prepared with GreenTrack  ·  Generated {genDate}</Text>
        </View>
        ...
        <Text style={s.footer} fixed>
          {company.name} — GHG Inventory — {period} — Generated by GreenTrack  ·  Emission factors are representative published values; verify against cited sources before external submission.
        </Text>
      </Page>
    </Document>
  );
