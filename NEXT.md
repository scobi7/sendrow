...
- **Branch `sendrow-v2`** = active. `main` (production, sendrow.app) is **stale** — deploying v2 to prod is your call.
...
| 5 | Decide production deploy of v2; Clerk prod Google OAuth; Calendly links; attorney ToS | various |
